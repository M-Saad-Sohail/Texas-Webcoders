...
const Packages = () => {
  ...
  return (
    <>
      ...
      <div className='flex justify-evenly flex-wrap p-4 gap-4'>
        {cards.map((card, index) => (
          <div key={index} className="flex flex-col justify-between w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
            <div>
